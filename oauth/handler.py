...
#Contact Info
id='sailing-project'
displayName = "OurSailingFamily"
displayImage="https://lh5.googleusercontent.com/-6TWDSsmtI4E/U9vXlOuPP3I/AAAAAAAAAB0/28jwkaOabo8/s705-no/603176f0-a671-4fb7-b670-2c893f29a2ae?sz=360"
email="charles.heath.berman@gmail.com"
phoneNumber="313-790-9851"
speakableName="Mookie"
...
class OAuthCodeExchangeHandler(OAuthBaseRequestHandler):
  ...
  def get(self):
    ...
    logging.info('Successfully stored credentials for user: %s %s', userid)
  ...
  def _perform_post_auth_tasks(self, userid, creds):
    logging.info('User is authorizing')
